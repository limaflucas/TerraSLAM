...
class PioneerDXController(Robot):
    def __init__(self, timestep: int, lidar_noise: float) -> None:
    ...
    def run(self) -> None:
        ...
        print("Press 'p' on the keyboard to PAUSE and ZOOM.")
        ...
        ekf_wrapper: EKF = EKF(self.timestep, R_matrix, Q_matrix, self.slam_graph)
        ...
        while self.step(self.timestep) != -1:
            ...
            if step_count % 10 == 0:
                ...
                self.slam_graph.append_data_time(self.timestep * step_count)
            ...
            if step_count % 100 == 0:
                ...
                # Updating the plots
                plt.pause(self.timestep / 1000.0)
...
if __name__ == "__main__":
    ...
    controller: PioneerDXController = PioneerDXController(timestep, lidar_noise)
    controller.run()
